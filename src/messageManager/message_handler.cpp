...
void msgHandler::sendSuggestion(dpp::cluster& bot, const dpp::message_create_t& event)
{
...
void msgHandler::modalForms::editSuggetionModal(dpp::cluster& bot, const dpp::form_submit_t& event) {
